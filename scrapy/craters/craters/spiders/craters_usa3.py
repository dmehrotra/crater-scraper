...
class CratersUsa3Spider(scrapy.Spider):
    name = 'craters_usa3'
    allowed_domains = ['johnstonsarchive.net']
    # start_urls = ['http://www.johnstonsarchive.net/nuclear/tests/USA-ntests3.html']
    start_urls = ['file:///C:/Users/kashi/Desktop/Craters/United_States_part_3,1973-1992.html']
